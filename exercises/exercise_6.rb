...
@store1.employees.create(first_name: "Javier", last_name: "Kimball", hourly_rate: 30)
...
@store2.employees.create(first_name: "Elvis", last_name: "Chan", hourly_rate: 10)
@store2.employees.create(first_name: "Charles", last_name: "Chou", hourly_rate: 20)
...
@store2.employees.create(first_name: "Nikola", last_name: "Tesla", hourly_rate: 20)
